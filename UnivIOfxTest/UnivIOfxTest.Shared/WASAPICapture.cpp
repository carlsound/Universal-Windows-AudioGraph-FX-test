...
using namespace UnivIOfxTest;


//
//  WASAPICapture()
//
UnivIOfxTest::WASAPICapture::WASAPICapture()
{
	m_BufferFrames = 0;
	m_cbDataSize = 0;
	m_cbHeaderSize = 0;
...
//
HRESULT UnivIOfxTest::WASAPICapture::InitializeAudioDeviceAsync()
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::ActivateCompleted(IActivateAudioInterfaceAsyncOperation *operation)
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::CreateWAVFile()
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::FixWAVHeader()
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::InitializeScopeData()
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::StartCaptureAsync()
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::OnStartCapture(IMFAsyncResult* pResult)
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::StopCaptureAsync()
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::OnStopCapture(IMFAsyncResult* pResult)
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::FinishCaptureAsync()
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::OnFinishCapture(IMFAsyncResult* pResult)
{
...
//
HRESULT UnivIOfxTest::WASAPICapture::OnSampleReady(IMFAsyncResult* pResult)
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::OnAudioSampleRequested(Platform::Boolean IsSilence)
{
    HRESULT hr = S_OK;
...
//
HRESULT UnivIOfxTest::WASAPICapture::ProcessScopeData(BYTE* pData, DWORD cbBytes)
{
    HRESULT hr = S_OK;
...
//  Callback method to stop capture
//
HRESULT UnivIOfxTest::WASAPICapture::OnSendScopeData(IMFAsyncResult* pResult)
{
    HRESULT hr = S_OK;
